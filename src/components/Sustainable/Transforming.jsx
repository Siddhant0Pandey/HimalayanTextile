...
export default function Transforming() {
  ...
  return (
    <div className=" text-gray-800 font-inter">
      {/* Transforming the Planet Section - Unique Design and Animation */}
      <section
      ...
      >
        ...
        <div className="card bg-white rounded-3xl shadow-2xl p-12 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6 animate__animated animate__fadeInLeft">
            <h2 className="text-4xl font-bold text-emerald-700 border-l-4 border-emerald-500 pl-4 tracking-tight">
            ...
            <ul className="list-disc list-inside space-y-2 text-lg text-gray-700">
              <li className="pl-4 text-green-700">
