...
const AboutSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20 text-center bg-gradient-to-br from-[#e6fff4] to-[#f0fff9] overflow-hidden"
    >
      <h2
        ref={titleRef}
      ...
      <div className="max-w-3xl text-lg md:text-xl mb-6 leading-relaxed text-[#154d30] space-y-4">
        {lines.map((line, i) => (
          <p
            key={i}
      ...
      <button
        ref={buttonRef}
        className="px-8 py-3 text-lg border-2 border-[#1fa951] text-[#1fa951] hover:bg-[#1fa951] hover:text-white transition duration-300 shadow-md opacity-0 scale-50"
      >
        Read More
      </button>
